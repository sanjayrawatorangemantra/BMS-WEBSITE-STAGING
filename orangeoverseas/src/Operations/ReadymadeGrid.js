...
const columns = [
  ...
  { key: "title", name: "Sub Type" },
  { key: "complete", name: "Size" },
  { key: "color", name: "Color" },
  { key: "brand", name: "Brand"},
  { key: "design", name: "Design"},
  { key: "fabricMaterial", name: "Fabric Material"},
  { key: "issueType", name: "Quantity", editor: IssueTypeEditor }
];
...
class ReadymadeGrid extends Component {
  state = { rows };
...
<div id="main">
    <div className="row">
      ...
      <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6">
               <h5 class="breadcrumbs-title mt-0 mb-0">ReadyMade Stock</h5>
    ...
    <div class="card-content">
      <p class="caption mb-0">ReadyMade Stock</p>
    </div>
  </div>
  </div>
<div>
