...
render () {
  ...
  <i class="fa fa-search search-icon" style={{color: '#fff'}}></i>
      <FormControl type="text" placeholder="Explore Materialize" className="mr-sm-2 search" />
...
<div class="footer-copyright">
        <div class="container"><span className="left">© 2019          <a href="http://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank">PIXINVENT</a> All rights reserved.</span><span class="right hide-on-small-only">Design and Developed by <a href="https://pixinvent.com/">PIXINVENT</a></span></div>
      </div>
</footer>
    </div>
  );
