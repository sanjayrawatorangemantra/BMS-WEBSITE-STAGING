...
<div id="main">
    <div className="row">
      ...
      <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6">
               <h5 class="breadcrumbs-title mt-0 mb-0">Add Readymade Garments</h5>
               <ol class="breadcrumbs mb-0">
                 <li class="breadcrumb-item"><a href="index.html">Home</a>
                 </li>
                 <li class="breadcrumb-item"><a href="#">Product Management</a>
                 </li>
                 <li class="breadcrumb-item active">Add Readymade Garments
                 </li>
               </ol>
             </div>
             <div class="col-lg-6">
    ...
    <div class="card-content">
      <p class="caption mb-0">Add Readymade Garments Details</p>
    </div>
  </div>
  </div>
        <div className="col-lg-12 col-md-12">
