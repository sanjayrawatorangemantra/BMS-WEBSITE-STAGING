...
var DataTable = require('react-data-components').DataTable;
     ...
     (val, row) =>
         ...
         <a class="btn01" href='/Dashboard/StockAccessoriesView'>
         Add Stock
       </a>;
...
render() {
  ...
  return(
    ...
    <div className="row">
      ...
      <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6">
               <h5 class="breadcrumbs-title mt-0 mb-0">Stock (Accessories) Management</h5>
               <ol class="breadcrumbs mb-0">
                 <li class="breadcrumb-item"><a href="index.html">Home</a>
                 </li>
                 <li class="breadcrumb-item"><a href="#">Stock Management</a>
                  </li> 
                 <li class="breadcrumb-item active">Stock (Accessories) Management
                 </li>
               </ol>
             </div>
    ...
    <div class="card-content">
      <p class="caption mb-0">Stock (Accessories) Management</p>
    </div>
  </div>
  </div>
