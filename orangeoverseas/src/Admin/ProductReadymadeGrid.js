...
const renderMapUrl =
    (val, row) =>
        ...
        <a class="btn01" href='/ProductViewReadymade'>
        View
      </a>;
...
render() {
  ...
  return(
    ...
    <div className="row">
      ...
      <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6">
               <h5 class="breadcrumbs-title mt-0 mb-0">Readymade Garment List</h5>
    ...
    <div class="card-content">
      <p class="caption mb-0" style={{color: '#fff'}}>Readymade Management</p>
    </div>
  </div>
  </div>
