...
class ReadyMade extends Component {
    constructor(props){
        super(props)
        this.state = {
            articleNumber: '',
    ...
    componentDidMount(){
      document.title = "Add New Readymade Garment || Orange Overseas || DOPS (Dealer Order Processing System)"
    }
...
<div id="main">
    <div className="row">
      ...
      <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6">
               <h5 class="breadcrumbs-title mt-0 mb-0">Add Readymade Garment</h5>
    ...
    <div class="card-content">
      <p class="caption mb-0" style={{color: '#fff'}}>Add Readymade Garments Details</p>
    </div>
  </div>
  </div>
        <div className="col-lg-12 col-md-12">
        ...
        <div class="card-content">
          <h4 class="card-title">Readymade Garments Details</h4>
