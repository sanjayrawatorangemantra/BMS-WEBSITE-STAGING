        ...
        <div class="container">
                        ...
                        <div class="row marginbtm-240">
                                ...
                                <div class="payment-box">
                                                        <h2 class="pull-left section-title text-center" style={{color:"#000",fontSize:"30px"}}>Payment Successful !</h2>
                                                       <img src="/assets/images/Payment_successfull.png" class="payment-failed"></img>
