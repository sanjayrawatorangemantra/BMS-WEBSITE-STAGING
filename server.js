                                                                                                                                                        ...
                                                                                                                                                        app.get('/verifyemail/:email', function(request, response) {
                                                                                                                                                            ...
                                                                                                                                                            app.get('/Termsmarketplace', function(request, response) {
                                                                                                                                                              ...
                                                                                                                                                              app.get('/festive-offers', function(request, response) {
                                                                                                                                                                ...
                                                                                                                                                                app.get('/accessories/:id/:category', function(request, response) {
                                                                                                                                                                  //   console.log('Home page visited!');
                                                                                                                                                                    const filePath = path.resolve(__dirname, './build', 'index.html');
                                                                                                                                                                    fs.readFile(filePath, 'utf8', function (err,data) {
                                                                                                                                                                      if (err) {
                                                                                                                                                                  ...
                                                                                                                                                                  app.get('/accessories/:accessoriesid/:varid/:accessoriesname', function(request, response) {
                                                                                                                                                                    //   console.log('Home page visited!');
                                                                                                                                                                      const filePath = path.resolve(__dirname, './build', 'index.html');
                                                                                                                                                                      fs.readFile(filePath, 'utf8', function (err,data) {
                                                                                                                                                                        if (err) {
                                                                                                                                                                    ...
                                                                                                                                                                    app.get('/covidessentials/:id/:category', function(request, response) {
                                                                                                                                                                      //   console.log('Home page visited!');
                                                                                                                                                                        const filePath = path.resolve(__dirname, './build', 'index.html');
                                                                                                                                                                        fs.readFile(filePath, 'utf8', function (err,data) {
                                                                                                                                                                          if (err) {
                                                                                                                                                                      ...
                                                                                                                                                                      app.get('/covidessentials/:category/:covidid/:varid/:covidname', function(request, response) {
                                                                                                                                                                        //   console.log('Home page visited!');
                                                                                                                                                                          const filePath = path.resolve(__dirname, './build', 'index.html');
                                                                                                                                                                          fs.readFile(filePath, 'utf8', function (err,data) {
                                                                                                                                                                            if (err) {
                                                                                                                                                                          ...
                                                                                                                                                                          app.get('/questions', function(request, response) {
                                                                                                                                                                            ...
                                                                                                                                                                            app.get('/answers', function(request, response) {
                                                                                                                                                                              ...
                                                                                                                                                                              app.get('/feedback', function(request, response) {
                                                                                                                                                                                ...
                                                                                                                                                                                app.get('/verifyeducationemail/:email/:otp', function(request, response) {
                                                                                                                                                                                  //   console.log('Home page visited!');
                                                                                                                                                                                    const filePath = path.resolve(__dirname, './build', 'index.html');
                                                                                                                                                                                    fs.readFile(filePath, 'utf8', function (err,data) {
                                                                                                                                                                                      if (err) {
