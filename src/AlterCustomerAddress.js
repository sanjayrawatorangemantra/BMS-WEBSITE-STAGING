...
class AlterCustomerAddress extends React.Component {
    ...
    componentDidMount(){
      ...
      var inf = localStorage.getItem('AddressData')
      var Customer = JSON.parse(inf)

      this.setState({
        Name : Customer.fld_name,
        Mobile :  Customer.fld_mobile,
        Address : Customer.fld_address,
        Street :  Customer.fld_street,
        Landmark :  Customer.fld_landmark,
        City :  Customer.fld_city,
        State :  Customer.fld_state,
        Country :  Customer.fld_country,
        Pincode :  Customer.fld_pincode,
        AddressId :  Customer.fld_id
      })
        ...
        GetApiCall.getRequest("GetCountry").then(resultdes =>
            resultdes.json().then(objcountry => {
              ...
              if(objcountry.data.length != 0 ){
              
                this.setState({
                    CountryId : objcountry.data.filter(value=>value.label == Customer.fld_country)[0].value,
                ...
                results.json().then(obj => {
                  if (results.status == 200 || results.status == 201) {
                    ...
                    if(obj.data.length != 0 ){
                        ...
                        this.setState({
                            StateId : obj.data.filter(value=>value.label == Customer.fld_state)[0].value,
                    ...
                    PostApiCall.postRequest(
                      ...
                      results.json().then(objcity => {
                        if (results.status == 200 || results.status == 201) {
                            ...
                            this.setState({
                                CityId : objcity.data.filter(value=>value.label == Customer.fld_city)[0].value,
                              ...
                              <option key={user.value} value={user.value}>
                                ...
                                <div class="form-footer">
                                    ...
                                    <div class="form-footer-right">
                                        ...
                                        type="submit" class="btn btn-primary">Update Address</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
export default AlterCustomerAddress;
