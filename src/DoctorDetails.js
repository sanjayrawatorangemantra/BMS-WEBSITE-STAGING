          ...
          <div class="row ">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 doctors-details ">
                    ...
                    <p class="doc-desc">
                      ...
                      <br></br>
                      {Parser(
                            ("<p>" + this.state.Doctor.fld_medicalassociation + "</p>")
                              .replace(/font-family/g, "")
                              .replace(/color/g, "")
                          )}
                    </p>}
                    ...
                    <p class="doc-desc">
                      ...
                      <br></br>
                     {Parser(
                            ("<p>" + this.state.Doctor.fld_rewardsrecognition + "</p>")
                              .replace(/font-family/g, "")
                              .replace(/color/g, "")
                          )}
                    </p>}
            ...
            >
             ...
             <div>
                      ...
                      {/* <img src={this.state.images1!==[]?this.state.images1[Math.floor(Math.random() * this.state.images1.length)]:null}/> */}
