...
class AccessoriesListing extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      Foot: [],
      ...
      PostApiCall.postRequest(
        {
          ...
          resultdes.json().then(obj => {
            ...
            this.setState({
              SizeData : Array.from(new Set(dt))
            })
   ...
   src={info.fld_mobileimage}/>   
        ...
        <div class="container doctors-section">
          ...
          <div class="col-md-3 col-sm-3 col-xs-3 col-3">
              ...
              <div class="brands">
                  <h5 style={{borderTop: '0px',paddingTop:'0px'}}>{this.state.CategorySelected}  <br/>( {this.state.FootDetails.length} Products )</h5>
                  </div>
                <div class="row">
    ...
    :
      ...
      <p class="discount-price">  You Save &#8377; {info.fld_price - info.fld_discountprice} ({info.fld_discountpercent}%)</p>
                      ...
                      <ul class="group-buttons">
                        ...
                        {this.state.FootwearData.find(cart=>cart.fld_accessoriesid==info.fld_accessoriesid)==undefined?   <li style={{display : info.fld_availability =='In stock' ? '' : 'none'}}>
                          {" "}
