...
const renderMapUrl =
    (val, row) =>
        ...
        <a href='/ProductViewReadymade' className="btn07">
...
class ProductReadymadeGrid extends Component {
    constructor(props){
        super(props)
        this.state = {
    ...
    componentDidMount(){
      document.title = "Readymade Garment List || Orange Overseas || DOPS (Dealer Order Processing System)"
    }
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6 col-sm-12">
               <h5 class="breadcrumbs-title mt-0 mb-0">Readymade Garments List</h5>
...
export default ProductReadymadeGrid;
