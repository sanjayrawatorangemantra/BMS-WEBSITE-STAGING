...
class ProductViewAccessories extends Component {
    constructor(props){
        super(props)
        this.state = {
            articleNumber: '',
...
<div id="main">
           ...
           <div class="row">
             <div class="col-lg-6 col-sm-12">
               ...
               <ol class="breadcrumbs mb-0">
                 ...
                 <li class="breadcrumb-item active">Accessory Details
                 </li>
               </ol>
             </div>
             <div class="col-lg-6 col-sm-12">
    ...
    <a href='/ProductAccessoriesGrid'><Button className="btn01" style={{float: 'right'}}
  ...
  <div className="col-lg-12 col-md-12">
        ...
        <div class="card-content">
          <h4 class="card-title">Accessory Details</h4>
       ...
       <div  className="input-field col-lg-6">
        ...
        <div id="prefixes" class="card card card-default scrollspy">
        <div class="card-content">
          <h4 class="card-title">Accessory Image</h4>
            <div className="col-lg-12">
            ...
            <div className="col-lg-12">
              ...
              <div className="row btngri">
                  <div className="col-lg-12">
                    ...
                    <a href='/ProductAccessoriesGrid'><Button className="btn01">Save</Button></a>
...
export default ProductViewAccessories;
