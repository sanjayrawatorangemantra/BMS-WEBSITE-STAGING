...
class Dispatch extends Component {
    ...
    componentDidMount(){
      document.title = "View Dispatch Details || Orange Overseas || DOPS (Dealer Order Processing System)"
    }
...
<div id="main">
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6 col-sm-12">
               <h5 class="breadcrumbs-title mt-0 mb-0">View Dispatch Details</h5>
               <ol class="breadcrumbs mb-0">
                 <li class="breadcrumb-item"><a href="index.html">Home</a>
                 </li>
                 <li class="breadcrumb-item"><a href="#">Dispatch Management</a>
                 </li> 
                 <li class="breadcrumb-item active">Dispatch Details
                 </li>
               </ol>
             </div>
             <div class="col-lg-6 col-sm-12">
    ...
    <a href='/DispatchGrid'><Button className="btn01" style={{float: 'right'}}
        ...
        <div className="row">
                  <div className="col-lg-12">
                    <div className="btn-align">
                        <Button className="btn01" style={{marginLeft: '15%'}}>SUBMIT</Button>
