...
const renderMapUrl =
    (val, row) =>
         <a class="btn05" href='/Dispatch'>
        <i class="fa fa-search-plus gridicon" aria-hidden="true"></i>
       </a>
...
var columns = [
  { title: 'Order No.', prop: 'orderNum', width: '18%'  },
  ...
  { title: 'Action', render: renderMapUrl, className: 'text-center', width: '17%' }

];

class DispatchGrid extends Component {
    constructor(props){
        super(props)
        this.state = {
