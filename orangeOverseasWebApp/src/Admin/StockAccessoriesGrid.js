...
(val, row) =>
    ...
    <span><Button type="button" className="btn01 btnStock">Stock History</Button></span>
...
(val, row) =>
    ...
    // <i class="fa fa-plus btn05" aria-hidden="true" data-toggle="modal" data-target="#myModal"></i>
...
//  var category = [ 'Chicago', 'Tampico', 'San Francisco', 'Mexico City', 'Boston', 'New York' ];
 ...
 var columns = [
  ...
  //  { title: 'Category', prop: 'category' },
   ...
   { title: 'Available Stock (Qty.)', prop: 'totalStock', width: '10%' },
...
class StockAccessoriesGrid extends Component {
    ...
    componentDidMount(){
      document.title = "Stock (Accessories) || Orange Overseas || DOPS (Dealer Order Processing System)"
    }
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6 col-sm-12">
               <h5 class="breadcrumbs-title mt-0 mb-0">Stock (Accessories) </h5>
        ...
        <div class="modal-content">
          <div class="modal-header gradient-45deg-indigo-purple">
           <div className="col-lg-12 col-md-12 ">
             ...
             <h5 class="breadcrumbs-title mt-0 mb-0 addcolr">Alter Stock (Accessories)</h5>
            ...
            <div className="col-lg-12">
              ...
              <div className="row btngri2">
                  <div className="col-lg-12">
                    ...
                    <a href='/StockAccessoriesGrid'><Button className="btn01"style={{float: 'right'}}>Save</Button></a>
