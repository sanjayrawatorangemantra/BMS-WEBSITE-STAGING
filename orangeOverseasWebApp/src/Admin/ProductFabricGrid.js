...
const renderMapUrl =
    ...
    // <Button className="btn01">View</Button>
        ...
        <a href='/ProductViewFabric' className="btn07">
...
var columns = [
  ...
  { title: 'Product Type', prop: 'ptype', width: '25%' },
 
 
  { title: 'Brand', prop: 'brand', width: '25%' },
  { title: 'Available Stock (Mtr.)', prop: 'tstock', width: '15%' },
  // { title: 'Product Name', prop: 'pname'  },
  // { title: 'Category', prop: 'category' },
  
  
  { title: 'Updated On', prop: 'Updatedon', width: '15%' },
...
class ProductFabricGrid extends Component {
    constructor(props){
        super(props)
        this.state = {
...
render() {
  ...
  return(
    ...
    <div className="row">
      ...
      <div class="card">
    <div class="card-content btnsearch">
      <div className="row">
  ...
  {/* <div className="container mgbt2 tabscr"> */}
...
export default ProductFabricGrid;
