...
var columns = [
  ...
  { title: 'Available Stock (Mtr.)', prop: 'tstock', width: '10%' },
...
render() {
  ...
  <i class="fa fa-search search-icon" style={{color: '#f8b006'}}></i>
      <FormControl type="text" placeholder="Search" className="mr-sm-2 search" style={{color:'black!important'}}/>
  ...
  <div className="grid-mobile">
    ...
    <div class="modal fade" id="myModal" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header gradient-45deg-indigo-purple">
           <div className="col-lg-12 col-md-12 ">
             ...
             <h5 class="breadcrumbs-title mt-0 mb-0 addcolr">Alter Stock (Fabric)</h5>
        ...
        {/* <div id="prefixes" class="scrollspy mgbt"> */}
        <div class="card-content">
          {/* <h4 class="card-title">Add Stock Detail </h4> */}
            <div className="col-lg-12">
            <div className="row">
            <div className="col-lg-6">
            <InputFloat
            ...
            <div className="col-lg-12">
              ...
              <div className="row btngri2">
                  <div className="col-lg-12">
                    ...
                    <a href='/StockFabricGrid'><Button className="btn01"style={{float: 'right'}}>Save</Button></a>
