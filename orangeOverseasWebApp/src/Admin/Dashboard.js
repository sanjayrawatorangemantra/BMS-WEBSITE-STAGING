      ...
      <div class="breadcrumbs-dark pb-0" id="breadcrumbs-wrapper">         
        ...
        <Pie data={dataP} height={340} width={315} options={options}/>
            ...
            <div class="card animate fadeLeft">
               ...
               <h4 class="card-title mb-0">Month Wise Order Statistics
                </h4>
...
<Dropdown.Menu style={{overflowY: 'scroll'}}>
      <Dropdown.Item eventKey="1">Fabric</Dropdown.Item>
      <Dropdown.Item eventKey="2">Accessories</Dropdown.Item>
      {/* <Dropdown.Item eventKey="3">
        Orange
      </Dropdown.Item> */}
      <Dropdown.Item eventKey="1">Readymade</Dropdown.Item>
    </Dropdown.Menu>
</Dropdown>
        ...
        <Pie data={dataP} height={250} width={400} options={options}/>
            ...
            <div class="padding-4">
              <div className="row">
               ...
               <div class="col-lg-8 col-sm-6 right-align" style={{paddingRight: '0px'}}>
            ...
            <div className="row">
               ...
               <div class="col-lg-9 col-sm-6 right-align">
                  ...
                  <p class="no-margin new">Total Sales : <i class="fa fa-rupee"></i>  822</p>
                  <p class="no-margin new">Sales this month : <i class="fa fa-rupee"></i> 422</p>
                  {/* <p className="new">3,</p> */}
               </div>
               </div>
            </div>
          ...
          <div className="col-lg-12">
            <div class="card subscriber-list-card animate fadeRight">
              <div class="card-content pb-1 gradient-45deg-indigo-purple">
            ...
            <tbody>
               ...
               <td>0112</td>
               <td> 
<i class="fa fa-rupee"></i> 1000.00</td>
               <td>Michael Austin</td>
           
                  
               
                 
                  <td><Button className="btn08" onClick={() =>{
                      this.props.history.push('/Dashboard/OrderView')
                  }}> <i class="fa fa-edit gridicon" aria-hidden="true"></i></Button></td>
               ...
               <td>0113</td>
               <td> 
<i class="fa fa-rupee"></i> 3000.00</td>
               <td>Aldin Rakić</td>
               ...
               <td>0114</td>
               <td> 
<i class="fa fa-rupee"></i> 2000.00</td>
               <td>İris Yılmaz</td>
               ...
               <td>0115</td>
               <td>  
<i class="fa fa-rupee"></i> 1100.00</td>
               <td>Lidia Livescu</td>
          ...
          <div className="row mgbt2">

<div className="col-lg-12">
<div class="card subscriber-list-card animate fadeRight">
              <div class="card-content pb-1 gradient-45deg-indigo-purple">
                <h4 class="card-title mb-0">Orders Dispatched Today 
                {/* <i class="fa fa-ellipsis-v" aria-hidden="true"></i> */}
                </h4>
    </div>
