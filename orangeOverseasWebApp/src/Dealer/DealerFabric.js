...
class DealerFabric extends Component {
    constructor(props){
        super(props)
        this.state = {
...
render() {
  ...
  return(
    ...
    <p class="caption mb-0">Fabric List</p>
        </div>
              ...
              <div className="row">
                   ...
                   <div className="detailbott">
                          <div className="row">
                              ...
                              <div className="col-lg-4 col-xs-6 deh">
                              <a href="/DealerFabricDetail"><i class="fa fa-info detai1" aria-hidden="true"></i></a>
                              </div>
