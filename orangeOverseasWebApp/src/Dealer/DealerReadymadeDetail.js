...
class DealerReadymadeDetail extends Component {
    constructor(props){
        super(props)
        this.state = {
            articleNumber: '',
...
<div id="main">
           ...
           <div class="row">
             <div class="col-lg-6">
               ...
               <ol class="breadcrumbs mb-0">
                 ...
                 <li class="breadcrumb-item active">View Readymade Details
                 </li>
               </ol>
             </div>
    ...
    <div class="card-content">
      <p class="caption mb-0" style={{color: '#fff'}}>View Fabric Details</p>
        ...
        <div class="card-content">
          <h4 class="card-title">Readymade Details</h4>
            <div className="row">
              ...
              <p>Peter England</p> 
               ...
               <p>Product Type : Ring</p>
               <p style={{fontSize:'25px'}}><b><i class="fa fa-inr" aria-hidden="true"></i>2000</b></p>
              </div>
                ...
                <div className="row">
                  <div className="col-lg-6">
                        <ul className="detailsbrandlist">
                          <li style={{float:'left'}}>Brand <span className="readym1">:Hulot</span></li><br/>
                         
                          <li style={{float:'left'}}>Color <span className="readym2">: Black</span></li><br/>
                           <li style={{float:'left'}}>Pattern <span className="readym3">: Latest</span></li><br/>
                           <li style={{float:'left'}}>Readymade Material <span className="readym4">: Stone</span></li><br/>
                        </ul>
                  </div>
                </div>
                {/* <div className="row">
...
export default DealerReadymadeDetail;
