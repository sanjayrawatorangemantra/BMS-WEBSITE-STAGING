...
class DealerReadymade extends Component {
    constructor(props){
        super(props)
        this.state = {
...
render() {
  ...
  <div className="container">
    ...
    <p class="caption mb-0">ReadymadeList</p>
        </div>
                ...
                <div className="row">
                   ...
                   <div className="detailbott">
                          <div className="row">
                              ...
                              <div className="col-lg-4 col-xs-6 deh">
                              <a href="/DealerReadymadeDetail"><i class="fa fa-info detai1" aria-hidden="true"></i></a>
                              </div>
...
export default  DealerReadymade;
