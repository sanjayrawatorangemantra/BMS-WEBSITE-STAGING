...
import DealerFabric from './DealerFabric';
...
import DealerFabricDetail from './DealerFabricDetail';
...
import DealerAccessoriesDetail from './DealerAccessoriesDetail';

import DealerReadymade from './DealerReadymade';
import DealerReadymadeDetail from './DealerReadymadeDetail';
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <i class="fa fa-clipboard fa-lg"></i> My Orders 
                <span class="arrow"></span>
                </li>
                  <ul class="sub-menu collapse" id="service">
                ...
                <i class="fa fa-shopping-bag fa-lg"></i> Products
                <span class="arrow"></span>
                </li>
                  <ul class="sub-menu collapse" id="product">
                  <Link to={'/DealerFabric'}><li>Fabric</li></Link>
                  <Link to={'/DealerAccessories'}><li>Accessories</li></Link>
                  <Link to={'/DealerReadymade'}><li>Readymade</li></Link>
                </ul>
...
<Switch>
      ...
      <Route path='/DealerFabric' exact component={DealerFabric} />
      <Route path='/DealerFabricDetail' exact component={DealerFabricDetail} />
      ...
      <Route exact path='/ProceedCheckout' component={ProceedCheckout} />
        
        <Route exact path='/DealerAccessories' component={DealerAccessories}/>
                <Route exact path='/DealerAccessoriesDetail' component={DealerAccessoriesDetail}/>

      <Route exact path='/DealerReadymade' component={DealerReadymade}/>
        <Route exact path='/DealerReadymadeDetail' component={DealerReadymadeDetail}/>
