...
class DealerAccessoriesDetail extends Component {
    constructor(props){
        super(props)
        this.state = {
            articleNumber: '',
    ...
    <div className="row">
      ...
      <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
         ...
         <div class="container">
           <div class="row">
             <div class="col-lg-6">
               <h5 class="breadcrumbs-title mt-0 mb-0">View Accessories Details</h5>
                ...
                <div className="row">
                  <div className="col-lg-6">
                        <ul className="detailsbrandlist">
                          <li style={{float:'left'}}>Brand <span className="Accesry1">:Hulot</span></li><br/>
                         
                          <li style={{float:'left'}}>Color <span className="Accesry2">: Black</span></li><br/>
                           <li style={{float:'left'}}>Pattern <span className="Accesry3">: Latest</span></li><br/>
                           <li style={{float:'left'}}>Accesory Material <span className="Accesry4">: Stone</span></li><br/>
                        </ul>
                  </div>
                </div>
                {/* <div className="row">
...
export default DealerAccessoriesDetail;
